...
% reading data of Kunpeng
    elseif strcmp(name,'Kunpeng-new')
        if strcmp(object,'plastic-cup')
            E{1} = csvread(['data/' name '/' object '/empty/0_right.csv']);
            E{1}(135:end,:) = 0;
            E{2} = csvread(['data/' name '/' object '/empty/1_right.csv']);
...
%             E{3} = csvread(['data/' name '/' object '/empty/2_right.csv']);
            ...
            F{2}(100:end,:) = 0;
%             F{1} = csvread(['data/' name '/' object '/full/3_right.csv']);
...
%             F{4} = csvread(['data/' name '/' object '/half/4_right.csv']);
    ...
    elseif strcmp(name,'Athanasios-new')
         if strcmp(object, 'red-cup')
            E{1} = csvread(['data/' name '/' object '/empty/0_right.csv']);
            E{2} = csvread(['data/' name '/' object '/empty/3_right.csv']);
            E{2}(1:20,:) = 0;
    ...
    elseif strcmp(name,'Athanasios')
         ...
         elseif strcmp(object, 'red-cup')
%             E{1} = csvread(['data/' name '/' object '/empty/0_right.csv']);
            E{1} = csvread(['data/' name '/' object '/empty/3_right.csv']);
            E{1}(85:end,:) = 0;
            E{1}(:,2:3) = -1*E{1}(:,2:3);
            %
            F{1} = csvread(['data/' name '/' object '/full/0_right.csv']);
...
%             F{1} = csvread(['data/' name '/' object '/full/2_right.csv']);
    ...
    elseif strcmp(name,'All')
            ...
            F{2} = csvread(['data/' 'Leo' '/' 'plastic-cup' '/full/1_right.csv']);
            F{2}(700:end,:) = 0;
            F{3} = csvread(['data/' 'Leo' '/' 'plastic-cup' '/full/2_right.csv']);
            F{3}(1100:end,:) = 0;
            F{4} = csvread(['data/' 'Salman' '/' 'red-mug' '/full/0_right.csv']);
            F{5} = csvread(['data/' 'Salman' '/' 'red-mug' '/full/1_right.csv']);
            F{6} = csvread(['data/' 'Salman' '/' 'red-mug' '/full/2_right.csv']);
            F{7} = csvread(['data/' 'Salman' '/' 'red-mug' '/full/3_right.csv']);
            F{8} = csvread(['data/' 'Salman' '/' 'red-mug' '/empty/0_right.csv']);
            F{9} = csvread(['data/' 'Salman' '/' 'red-mug' '/empty/1_right.csv']);
            F{10} = csvread(['data/' 'Salman' '/' 'red-mug' '/empty/3_right.csv']);
